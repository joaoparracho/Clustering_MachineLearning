...
def runRun(dataTrain,dataTest,outputTrain,outputTest,rmt,mode,addtitleTxt):
    ...
    writeLogs("logs/ERROR METRICS-"+operationMode[rmt]+"-"+addtitleTxt+".txt",4,[str(MAE_regression_Test),str(MSE_regression_Test),str(RMSE_regression_Test),str(MAPE_regression_Test)],["MAE","MSE","RMSE","MAPE"],"EVALUATE ERROR METRICS\n"+operationMode[rmt],mode)
